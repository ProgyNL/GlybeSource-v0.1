...
jQuery(document).ready(function(){
	Glybe.Initialize();
	Glybe.Notifications.Create('Script redirect?', 'Heb je dit script op je website staan en word je naar deze pagina gestuurd? Bewerk dan de configuratie van het script!', 'redirect', '#', 10000);
});