	...
	<div class="footer">
		...
		<div class="inner" style="padding: 7px 20px;">
			...
			<center><i>Copyright &copy; <?php echo date("Y"); ?> Glybe - Alle rechten voorbehouden aan <a href="http://www.HetIsNiels.nl/" target="_blank">Niels van Velzen</a> &amp; <a href="http://www.basmilius.com/" target="_blank">Bas Milius</a>.</i></center>
		</div>
	</div>
