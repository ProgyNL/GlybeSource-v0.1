...
if(isset($page['access']))
{
	...
	if(isset($access[2]) && isset($user) && !$account->rang == 'administrator')
	{
...
<head>
	...
	<script type="text/javascript" src="/cache/javascript/glb.s.js"></script>
	<script type="text/javascript" src="/cache/javascript/glybe.js#v=glb_v0.8.1"></script>
